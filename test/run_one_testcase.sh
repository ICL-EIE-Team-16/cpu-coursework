...
set +e
grep "${REG_PATTERN}" test/test-cases/${TESTCASE}/${BASE_TEST_BENCH}_${TESTCASE}.stdout | sed -e "s/${REG_PATTERN}/${NOTHING}/g" > test/test-cases/${TESTCASE}/${BASE_TEST_BENCH}_${TESTCASE}.out-reg.csv
set -e
